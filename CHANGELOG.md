...
* [CHANGE] Querier: returning 422 when query hits `max_fetched_chunks_per_query` and `max_fetched_series_per_query` limits either in the store-gateway or in querier. #4056 #4100
